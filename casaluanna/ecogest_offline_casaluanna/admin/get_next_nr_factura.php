...
require_once __DIR__.'/database_connection.php'; // Ensure this includes your PDO connection
    ...
    if (isset($_POST['serie_factura'])) {
        ...
        try {
            ...
            if ($result['max_nr'] === null) {
                $sql_nr_inceput = "SELECT nr_inceput FROM casa_online_series WHERE serie = :serie_factura";
