...
if (isset($_GET['q'])) {
    ...
    // Formula: pret_achizitie * (1 + cota_tva / 100)
    $sql_produse = "
        SELECT 
            um, 
            pret_cu_tva, 
            ...
            nume, 
            pret_achizitie,
            (pret_achizitie * (1 + cota_tva / 100)) AS pret_achizitie_calculat 
    ...
    if ($product) {
        ...
        $sql_vanzari = "SELECT um, pret_cu_tva, cota_tva FROM vanzari WHERE cod_produs = :cod_produs";
