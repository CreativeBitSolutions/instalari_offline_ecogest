...
$df_ef_stmt = $pdo->query("SELECT email FROM date_firma LIMIT 1");
...
if (!$factura_trimisa_anaf) {
    echo '<a href="factura.php?id_factura=' . $id_factura . '" class="btn btn-primary btn-block">Modifică Factura</a>';
        echo '<a href="factura.php?id_factura=' . $id_factura . '" class="btn btn-secondary btn-block">Validare și Încărcare Factura ANAF</a>';
