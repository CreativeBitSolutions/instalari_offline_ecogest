...
try{
    ...
    if($source<1||$revision<1||(int)($invoice['id_factura']??0)!==$source||(int)($invoice['nr_factura']??0)<1||trim((string)($invoice['serie_factura']??''))===''||empty($body['vanzari']))throw new OfflineSyncHttpException(400,'Factura este incompletă.');
