...
<select id='selectInp' style="width:100%;" onclick='window.loadStates()' onchange='window.loadStates()'   name="categ" class="js-example-basic-single"><option id='toate' value='999'>TOTI FURNIZORII</option>
  <?php
...
printf("<script>location.href='fisa_furnizor.php'</script>");
 ...
 ?>
               ...
               <div class='two'> <object width="100%" height="600" data="listeaza_nir.php"></object></div>
