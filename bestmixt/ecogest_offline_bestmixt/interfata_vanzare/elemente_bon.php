...
$f_sql = "SELECT COALESCE(n.pret_cu_tva, dn.pret_vanzare) as pret_initial, dn.preparat, dn.pachet, dn.discount, dn.cod_p, dn.nume_produs as nume, dn.cota_tva, COALESCE(n.um, 'buc') AS um, dn.cantitate, dn.tva_col, dn.pret_vanzare, dn.valoare_vanzare, dn.valoare_vanzare_cu_tva, dn.id_vanz
          FROM $tabel_final_det_note dn
          LEFT JOIN $tabel_final_nomenclator n ON dn.cod_p = n.cod_produs
        ...
        <div class="tab-pane fade show active" id="total-tab-content" role="tabpanel" aria-labelledby="total-tab-link">
            <div class="totals-inline-grid">
                ...
                <div class="total-item">
                    ...
                    <input type="text" id="suma-incasata-input" name="suma-incasata-input" class="form-control form-control-sm" placeholder="0.00" readonly value="<?php echo number_format($total_val_vz_cu_tva, 2, '.', ''); ?>">
                </div>
                <div class="total-item">
                    <label>R:</label>
