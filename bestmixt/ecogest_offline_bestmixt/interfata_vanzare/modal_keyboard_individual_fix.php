<?php // modal_keyboard_individual_fix.php ?>
<div class="modal fade" id="keyboardModalIndividualFix" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width: 320px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Introduceți Suma Fixă (RON)</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <input type="text" id="keyboard-display-individual-fix" class="form-control text-right mb-3" style="font-size: 1.8rem; height: auto;" readonly>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="keyboard-save-individual-fix">Salvează</button>
            </div>
        </div>
    </div>
</div>