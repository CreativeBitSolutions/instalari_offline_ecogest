...
class PDF_NIR_STD_L extends FPDF {
    public $firma;
    public $start_date;
    public $end_date;
    public $cota_tva;
    ...
    function Header() {
        ...
        $this->Cell(0,8,'Raport Note de Receptie (NIR)',0,1,'C');
...
$filename_parts = ['Raport_NIR_Standard_Landscape','de_la_'.$start_date,'pana_la_'.$end_date];
