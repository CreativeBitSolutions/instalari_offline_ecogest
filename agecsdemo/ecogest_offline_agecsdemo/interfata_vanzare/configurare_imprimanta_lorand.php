...
if ($clientId !== 8) {
    ...
    echo 'Configurarea imprimantei este disponibilă numai pentru AGECSDEMO.';
    exit;
}
...
if ($apiRoot === '') {
    ...
    echo 'Folderul API offline AGECSDEMO nu este configurat.';
    exit;
}
...
<head>
    ...
    <title>Configurare imprimantă AGECSDEMO</title>
...
<div class="shell">
    <div class="card-local">
        <div class="kicker">ECOGEST MAGAZIN AGECSDEMO · client 8</div>
