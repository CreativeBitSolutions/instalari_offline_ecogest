 ...
 * * MODIFICARE: Clienții 6 și 8 pot adăuga linii cu cantitate negativă (INSERT/UPDATE cu minus).
 */
...
try {
    ...
    // MODIFICARE: Am adăugat verificarea pentru client_id 6 și 8
    // Astfel, acești clienți intră pe ramura de INSERT/UPDATE chiar dacă cantitatea e negativă
    if ($cantitate >= 0 || in_array($client_id, [6])) {
        // --- LOGICA DE ADĂUGARE / MĂRIRE CANTITATE (Sau adăugare negativă pentru 6,8) ---
        if ($qty_has3) {
        ...
        // Dacă există deja aceeași linie (același cod, același preț, același pachet), cumulăm cantitatea
        ...
        // --- CANTITATE NEGATIVĂ → SCADERE FĂRĂ RÂNDURI NEGATIVE (Comportament Standard) ---
