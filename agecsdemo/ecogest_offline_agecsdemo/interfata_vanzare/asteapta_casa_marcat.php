...
$directFiscalEnabled = $clientId === 8 && $locationId > 0;
...
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST'
    ...
    if (!$directFiscalEnabled
        ...
        echo json_encode(['success' => false, 'message' => 'Operația este disponibilă numai în instalarea locală AGECSDEMO.'], JSON_UNESCAPED_UNICODE);
        exit;
    }
