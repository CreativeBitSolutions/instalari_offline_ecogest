...
<main class="report-page-bar">
    <section class="report-page-card">
        <small class="text-uppercase text-muted font-weight-bold">Restaurant</small>
        <h1 class="h3 mt-1">Rapoarte produse</h1>
        ...
        <div class="report-page-actions">
            <a class="btn btn-outline-dark" href="vanzare_restaurant.php?deschide_mese=1">Înapoi la mese</a>
