...
if (!function_exists('lorand_payment_note_enqueue')) {
    ...
    {
        if ($clientId !== 1019) {
            throw new InvalidArgumentException('Listarea automată Lorand este disponibilă numai pentru clientul 1019.');
        }
        ...
        try {
            ...
            $queuePath = agecs_printer_enqueue_payload($clientId, $locationId, [
                'status' => 'success',
                'message' => 'Nota de plată Lorand a fost pregătită pentru imprimanta BAR.',
                'data' => $jobs,
