...
<main class="shell">
    <header class="topbar">
        <div>
            <div class="eyebrow">ECOGEST RESTAURANT</div>
            <h1>Istoric note PROTOCOL</h1>
        </div>
        <a class="back" href="vanzare_restaurant.php">Înapoi la vânzare</a>
    </header>
    ...
    <form class="filters" method="get">
        ...
        <div class="filter-actions"><button class="btn btn-primary" type="submit">Aplică filtrul</button><a class="btn btn-light" href="vanzare_istoric_protocol.php">Toate notele</a></div>
    </form>
