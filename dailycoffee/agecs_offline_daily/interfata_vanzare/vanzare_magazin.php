        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="admin-link-grid">
                    ...
                    <a href="produse_admin.php">
                        <i class="fas fa-box"></i> Produse
                        <small>CRUD produse si retete</small>
                    </a>
                    <a href="categorii_admin.php">
                        <i class="fas fa-tags"></i> Categorii
                        <small>CRUD categorii</small>
                    </a>
...
<?php endif; ?>
                    <div class="form-group">
                        ...
                        <div class="input-group">
<?php $initialQty = ($_SESSION['client_id'] == 999) ? '' : '1'; ?>
<input type="text"
