                    ...
                    <?php foreach ($nirs as $nir): ?>
                        <tr>
                            ...
                            <td class="dt-nowrap">
                                ...
                                <a href="listeaza_nir.php?nr_nir=<?= urlencode($nir['nr_nir']) ?>&spatii=1" class="btn btn-sm btn-info" title="PDF cu rezumat pe pagina separata">LISTEAZA CU SPATII</a>
                                <a href="listeaza_nir.php?nr_nir=<?= urlencode($nir['nr_nir']) ?>&spatii=0" class="btn btn-sm btn-outline-info" title="PDF fara page break inainte de rezumat">LISTEAZA FARA SPATII</a>
