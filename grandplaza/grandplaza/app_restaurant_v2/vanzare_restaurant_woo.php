...
// Wrapper de compatibilitate pentru instalarea Grand Plaza.
...
if(strpos($html,'id="wooImportTile"')===false){
    ...
    $tile='<a href="woo_offline_import.php" id="wooImportTile" class="quick-action-tile btn btn-outline-secondary fit-grid-text woo-import-tile" title="Import Comenzi Site"><span>Import Comenzi Site</span><span id="wooImportBadge" class="woo-import-badge" aria-label="Comenzi Woo noi" style="display:none">0</span></a>';
