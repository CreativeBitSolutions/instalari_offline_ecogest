...
```http
GET https://agecs.agecs.in/api/offline-tablet-orders.php?cod_client=25&cod_locatie=1&limit=200
...
```http
POST https://agecs.agecs.in/api/offline-tablet-orders.php?cod_client=25
