    ...
    <div class="card settings-card">
        ...
        <div class="card-body p-4">
            ...
            <form method="post">
                ...
                <div id="printerPreview" class="preview-paper mb-4" style="font-weight: <?php echo $previewWeight; ?>; font-size: <?php echo $previewSize; ?>; text-align: <?php echo $previewAlign; ?>;">GRAND PLAZA
Masa 1
2 x Produs exemplu
TOTAL 50,00 LEI</div>
