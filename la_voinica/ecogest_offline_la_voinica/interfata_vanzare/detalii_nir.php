...
while ($row = $misc_stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    $iessql = "insert into $tabel_final_miscari(data,cod_p,cantitate_misc,tip_miscare,fel_doc,nr_doc,pu,ramas) values('$data_nir','$prod','$qt','I','NIR','$nr_nir','$pu','$qt');";   
...
echo '<form method="post">
 <input type="submit" class="btn btn-primary btn-block" name="list_nir" value="Listează NIR">
 </form>';
