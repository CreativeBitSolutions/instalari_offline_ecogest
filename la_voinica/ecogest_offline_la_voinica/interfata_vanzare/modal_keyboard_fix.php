<?php // modal_keyboard_fix.php ?>
<div class="modal fade" id="keyboardModalFix" tabindex="-1" role="dialog" aria-labelledby="keyboardModalFixLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width: 320px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" id="keyboard-display-fix" class="form-control text-right mb-3" style="font-size: 1.8rem; height: auto;" readonly>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="keyboard-save-fix">Salvează</button>
            </div>
        </div>
    </div>
</div>