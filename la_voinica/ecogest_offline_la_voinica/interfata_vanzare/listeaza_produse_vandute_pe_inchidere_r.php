...
$cod_inchidere=$_SESSION['cod_inchidere'];
     $bon_sql = "SELECT $tabel_final_inchideri_r.data_inchiderii,$tabel_final_inchideri_r.ora_inchiderii FROM $tabel_final_inchideri_r where $tabel_final_inchideri_r.cod_inchidere='$cod_inchidere'";    
