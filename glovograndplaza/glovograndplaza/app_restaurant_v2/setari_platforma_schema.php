...
if (!function_exists('restaurant_v2_set_skip_bar_command_print_enabled')) {
    function restaurant_v2_set_skip_bar_command_print_enabled(PDO $pdo, bool $enabled): bool
    {
        ...
        try {
            ...
            $stmt = $hasRow
                ? $pdo->prepare("UPDATE setari_platforma SET omite_listare_bar_la_trimitere = :enabled")
                : $pdo->prepare("INSERT INTO setari_platforma (omite_listare_bar_la_trimitere) VALUES (:enabled)");
