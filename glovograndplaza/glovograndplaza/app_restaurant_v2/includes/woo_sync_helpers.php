...
if (!function_exists('woo_sync_write_site_bar_queue_file')) {
    function woo_sync_write_site_bar_queue_file(string $content, int $wooOrderId, int $codLocatie): string {
        ...
        $queueBaseDir = (string)($cfg['printer_queue_base_dir'] ?? (defined('RESTAURANT_OFFLINE_API_DIR') ? RESTAURANT_OFFLINE_API_DIR : dirname(dirname(dirname(__DIR__))) . '/api_offline_glovograndplaza'));
