  ...
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Documente">
	    ...
	    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Nomenclator">
          ...
          <ul class="sidenav-second-level collapse" id="collapseProd">
              <li>
              <a href="#" class="disabled" aria-disabled="true" title="Gestionare în online" onclick="return false;">Lista Produselor <small>(gestionare în online)</small></a>
            </li>
            <li>
              <a href="#" class="disabled" aria-disabled="true" title="Gestionare în online" onclick="return false;">Creează produs <small>(gestionare în online)</small></a>
            </li>
              <li>
              <a href="#" class="disabled" aria-disabled="true" title="Gestionare în online" onclick="return false;">Lista categoriilor <small>(gestionare în online)</small></a>
            </li>
            <li>
              <a href="#" class="disabled" aria-disabled="true" title="Gestionare în online" onclick="return false;">Creează categorie <small>(gestionare în online)</small></a>
            </li>
