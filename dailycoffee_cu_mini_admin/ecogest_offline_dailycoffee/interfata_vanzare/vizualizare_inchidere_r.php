...
$bon_sql = "SELECT $tabel_final_inchideri_r.data_inchiderii,$tabel_final_inchideri_r.ora_inchiderii,$tabel_final_inchideri_r.tva_colectata,$tabel_final_inchideri_r.valoare_cu_tva,$tabel_final_admins.admin_firstname,admin_lastname FROM $tabel_final_inchideri_r inner join $tabel_final_admins on $tabel_final_inchideri_r.operator=$tabel_final_admins.admin_id  where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'";    
...
$min_datetime_sql="select min(cast(concat($tabel_final_note.data_bon, ' ',$tabel_final_note.ora_bon) as datetime)) as min_dt from $tabel_final_note where $tabel_final_note.cod_inchidere='$cod_inchidere'  and $tabel_final_note.locatie='$cod_locatie'";
...
$max_datetime_sql="select max(cast(concat($tabel_final_note.data_bon, ' ',$tabel_final_note.ora_bon) as datetime)) as max_dt from $tabel_final_note where $tabel_final_note.cod_inchidere='$cod_inchidere' and $tabel_final_note.locatie='$cod_locatie'";
...
//CELL(width,height,text,border,end line,[align])
 ...
 $f_tot_sql = "SELECT sum($tabel_final_note.numerar-$tabel_final_note.rest) as total_numerar from $tabel_final_note where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'; ";    
...
$tichete_tot_sql = "SELECT sum($tabel_final_note.tichete) as total_tichete from $tabel_final_note where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'; ";
...
while ($row = $tichete_tot_stmt->fetch(PDO::FETCH_ASSOC)){
 ...
 $rest_tot_sql = "SELECT sum($tabel_final_note.rest) as total_rest from $tabel_final_note where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'; ";    
...
while ($row = $rest_tot_stmt->fetch(PDO::FETCH_ASSOC)){
 ...
 $disc_tot_sql = "SELECT sum($tabel_final_note.discount) as total_discount from $tabel_final_note where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'; ";    
...
while ($row = $disc_tot_stmt->fetch(PDO::FETCH_ASSOC)){
 ...
 $ds_tot_sql = "SELECT sum($tabel_final_note.card) as total_card from $tabel_final_note where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'; ";    
...
$protocol_sql = "SELECT sum($tabel_final_note.protocol) as tot_protocol FROM $tabel_final_note where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'; ";
...
$max_bon_sql = "SELECT max($tabel_final_note.nrbon) as max_bon from $tabel_final_note where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'; ";    
...
$min_bon_sql = "SELECT min($tabel_final_note.nrbon) as min_bon from $tabel_final_note where cod_inchidere='$cod_inchidere' and locatie='$cod_locatie'; ";    
...
$pdf->Cell(15,5,'',0,1,'R');
$pdf->Cell(38,5,'Note: '.$nr_primul_bon.' - '. $nr_ultim_bon ,'B,T',1,'C',false);
