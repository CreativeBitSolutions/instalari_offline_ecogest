...
$where_clause = "WHERE g.denumire_gestiune NOT IN ('MATERII', 'CONSUMABILE', 'MATERIALE AUXILIARE')
    AND n.activ = 1
    AND EXISTS (
        SELECT 1 FROM produse_servicii_locatii psl
        WHERE psl.cod_produs = n.cod_produs
          AND psl.cod_locatie = :locatie_produs
          AND psl.activ = 1
    )";
$params[':locatie_produs'] = (int)$cod_locatie;
