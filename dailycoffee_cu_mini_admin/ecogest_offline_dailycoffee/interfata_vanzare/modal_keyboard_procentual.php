<?php // modal_keyboard_procentual.php ?>
<div class="modal fade" id="keyboardModalProcentual" tabindex="-1" role="dialog" aria-labelledby="keyboardModalProcentualLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width: 320px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" id="keyboard-display-procentual" class="form-control text-right mb-3" style="font-size: 1.8rem; height: auto;" readonly>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="keyboard-save-procentual">Salvează</button>
            </div>
        </div>
    </div>
</div>