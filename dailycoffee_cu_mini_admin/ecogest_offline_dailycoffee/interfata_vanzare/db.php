...
try {
    ...
    require_once __DIR__ . '/dailycoffee_product_location_schema.php';
    dailycoffeeLocalProductLocationEnsureSchema($pdo);
...
$tabel_final_comenzi_detalii     = 'comenzi_detalii';
...
$tabel_final_inchideri_r         = 'inchideri_r';
$tabel_final_loc_mese            = 'loc_mese';
