...
$min_datetime_sql="select min(cast(concat($tabel_final_bonuri.data_bon, ' ',$tabel_final_bonuri.ora_bon) as datetime)) as min_dt, max(cast(concat($tabel_final_bonuri.data_bon, ' ',$tabel_final_bonuri.ora_bon) as datetime)) as max_dt FROM $tabel_final_bonuri where $tabel_final_bonuri.cod_inchidere=0 and $tabel_final_bonuri.operator='$adm_id' and $tabel_final_bonuri.status='F'";
...
$pdf->MultiCell(38,5,'PRODUSE VANDUTE ASTAZI' ,'T','C',false);
