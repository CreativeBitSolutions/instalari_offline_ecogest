...
$cod_locatie = (int)($app_cod_locatie ?? $_SESSION['cod_locatie'] ?? 2);
$mese_desch_sql = "SELECT nrbon,cod_masa from $tabel_final_note where status='S' and tableta='$l' and $tabel_final_note.locatie=:cod_locatie";    
$mese_desch_stmt = $pdo->prepare($mese_desch_sql);  
$mese_desch_stmt->execute([':cod_locatie' => $cod_locatie]); 
