...
class PDF_NIR_AGR_P extends FPDF {
    public $firma;
    public $start_date;
    public $end_date;
    var $widths;
    ...
    function Header() {
        ...
        $this->Cell(0,7,'Raport Note de Receptie (NIR) - AGREGAT',0,1,'C');
...
// latimi ajustate portret pentru 10 coloane
$pdf->SetWidths([30,16,30,18,14,14,18,16,18,18]);
...
$filename = 'Raport_NIR_Agregat_Portrait_de_la_'.$start_date.'_pana_la_'.$end_date.'.pdf';
