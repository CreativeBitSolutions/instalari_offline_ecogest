...
$pdf->Cell(38,5,'OPERATOR: '.$admin_firstname.' '. $admin_lastname ,'B',1,'L',false);
...
$pdf->Cell(10,5,$pret_vanzare,0,0);
...
$pdf->Cell(15,5,'',0,1,'R');}
if($tichete!=0){
$pdf->Cell(13  ,5,'Tichete',0,0);
$pdf->Cell(23  ,5,$tichete,0,0,'R');
$pdf->Cell(15,5,'',0,1,'R');
}
if($card!=0){
...
if($tva_a>0){
	$pdf->Cell(13  ,5,'A: TVA A (19%) ',0,0);
$pdf->Cell(23  ,5,$tva_a,0,1,'R');}
if($tva_b>0){
	$pdf->Cell(13  ,5,'B: TVA B (9%) ',0,0);
$pdf->Cell(23  ,5,$tva_b,0,1,'R');}
	if($tva_c>0){$pdf->Cell(13  ,5,'C: TVA C (5%) ',0,0);
$pdf->Cell(23  ,5,$tva_c,0,1,'R');}
	$pdf->Cell(13  ,5,'FARA TVA ',0,0);
$pdf->Cell(23  ,5,$faratva,0,1,'R');
	$pdf->Cell(13  ,5,'TOTAL TVA',0,0);
$pdf->Cell(23  ,5,$tva_colectata,0,1,'R');
$pdf->Cell(38  ,5,'Nr. nota: '.$nr_bon,0,1);
