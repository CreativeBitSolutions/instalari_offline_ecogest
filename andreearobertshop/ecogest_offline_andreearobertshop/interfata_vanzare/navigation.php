...
.menudown:hover .menudown-content {
    display: block;
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Vanzare">
        <a class="nav-link" href="vanzare_magazin.php">
          <i class="fa fa-fw fa-shopping-cart"></i>
          <span class="nav-link-text">Vanzare</span>
        </a>
      </li>

      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Export offline">
        <a class="nav-link" href="export_vanzari_offline.php">
          <i class="fa fa-fw fa-download"></i>
          <span class="nav-link-text">Export offline</span>
        </a>
      </li>

<?php if (!offline_sales_only_enabled()): ?>
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Documente">
	    ...
	    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Nomenclator">
          ...
          <ul class="sidenav-second-level collapse" id="collapseProd">
              <li>
              <a href="nomenclator.php">Lista Produselor </a>
            </li>
            <li>
              <a href="adauga_produs.php">Creaza Produs</a>
            </li>
              <li>
              <a href="admin_categories.php">Lista Categoriilor </a>
            </li>
            <li>
              <a href="add_category.php">Creaza Categorie</a>
            </li>
...
<?php if (!offline_sales_only_enabled()): ?>
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Administrare">
          ...
          <ul class="sidenav-second-level collapse" id="collapseadm">
            ...
            <li>
              <a href="add_admin.php">Creaza Administrator</a>
            </li>
            <li>
...
$asql = "SELECT * FROM $tabel_final_admins WHERE admin_id='$admin_em'";    
...
<?php if (!offline_sales_only_enabled()): ?>
            <div class="dropdown-message medium">
                <a class="dropdown-item" href="edit_profile.php"> Modifica cont</a>
                
</div>
          <div class="dropdown-divider"></div>
<?php endif; ?>
          <a class="dropdown-item small" href="logout_admin.php">Deconectare</a>
        </div>
      </li>
